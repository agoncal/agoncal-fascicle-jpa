...
public class NewsTest extends AbstractPersistentTest {
  ...
  public void shouldCreateOneNewsWithFourComments() throws Exception {
    ...
    Comment comment1 = new Comment("elvis", "First comment", 3);
    Comment comment2 = new Comment("gonzo", "Second comment", 5);
    Comment comment3 = new Comment("gonzo", "Third comment", 1);
    Comment comment4 = new Comment("elvis", "Fourth comment", 2);
